 ...
 */
public class ImageDownloadTask extends AsyncTask<Object, Void, MyImage> {

    private Context context;
    private IUpdateGrid iUpdateGrid;
    private String link;

    public ImageDownloadTask(Context context, IUpdateGrid iUpdateGrid, String link) {
    ...
    protected void onPostExecute(MyImage imageView) {
        iUpdateGrid.AddImage(imageView);
    }
}
